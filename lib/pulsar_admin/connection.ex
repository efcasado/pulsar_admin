...
defmodule PulsarAdmin.Connection do
  @moduledoc """
  Handle Tesla connections for PulsarAdmin.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:pulsar_admin, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - PulsarAdmin 1.0.0 - elixir"
        )
      )
